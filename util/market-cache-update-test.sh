...
ONLY_FILE="only_market.json"
ONLY_CUSTOM_FILE="only_custom_market.json"
OUTPUT_FILE="mainnet.json"
ONLY_OUTPUT_FILE="mainnet_only_market.json"
BACKUP_FILE="mainnet.json.backup"
ONLY_BACKUP_FILE="mainnet_only_market.json.backup"
